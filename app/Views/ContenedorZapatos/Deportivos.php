        ...
        <div class="row"> <!-- Fila para organizar los productos en columnas -->
            ...
            <div class="col-md-4"> <!-- Columna que ocupa un tercio del ancho en pantallas medianas -->
                <div class="card"> <!-- Tarjeta Bootstrap para mostrar producto -->
                    <img src="<?= base_url('public/img/zapato1.webp') ?>" class="card-img-top" alt="Zapato Deportivo">
            ...
            <div class="col-md-4">
                <div class="card">
                    <img src="<?= base_url('public/img/zapato2.avif') ?>" class="card-img-top" alt="Zapato Deportivo">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card">
                    <img src="<?= base_url('public/img/zapato3.jpg') ?>" class="card-img-top" alt="Zapato Deportivo">
                    <div class="card-body">
